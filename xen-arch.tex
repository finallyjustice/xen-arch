...
\column{.7\textwidth}
\begin{itemize}
\item COLO - Coarse Grain Lock Stepping
\item LivePatch
\item Stealthy monitoring with Xen altp2m
\item Real-Time-Deferrable-Server(RTDS) CPU Scheduler
\item Windows PV Receive Side Scaling
\item More at Xen Summit and xen-devel
\end{itemize}
\column{.3\textwidth}
\begin{center}
\begin{figure}
